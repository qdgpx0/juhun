...
function(e, t) {
    ...
    r.prototype.loading = function(t) {
        ...
        this.element.removeAttribute("readonly");
            ...
            0 == i.length && (i = e('<div class="ace-file-overlay"></div>').appendTo(this.$container), i.on("click tap",
            function(e) {
    ...
    var o = function() {
        ...
        function(t) {
            if (t.preventDefault(), t.stopPropagation(), !e.disabled) {
                ...
                i === !1 ? !1 : (e.$element.data("ace_input_method", "drop"), e.$element.data("ace_input_files", i), e.show_file_list(i), e.$element.triggerHandler("change", [!0]), !0)
            }
        })
    },
    l = function() {
...
function(e) {
    ...
    e(document).on("focus.bs_typeahead.data-api", '[data-provide="bs_typeahead"]',
    function() {
        var t = e(this);
...
function(e) {
    e.fn.ace_wizard = function(t) {
        return this.each(function() {
            ...
            n.$prevBtn.remove(),
            n.$nextBtn.remove(),
            n.$prevBtn = i.find(".btn-prev").eq(0).on(ace.click_event,
            function() {
                n.previous()
            }).attr("disabled", "disabled"),
            n.$nextBtn = i.find(".btn-next").eq(0).on(ace.click_event,
            function() {
                n.next()
            }).removeAttr("disabled"),
