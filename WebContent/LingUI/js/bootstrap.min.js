...
function(a) {
	...
	c.prototype.show = function(b) {
		...
		var aaaaa=this.$element.children().eq(0);
		this.$element.children().eq(0).css("position", "absolute").css({
          "margin":"0px",
          "top": function () {
                    return (document.documentElement.clientHeight - aaaaa.height()) / 2 + "px";
          },
          "left": function () {
              return (document.documentElement.clientWidth - aaaaa.width()) / 2 + "px";
          }
      });
	  $(window).resize(function(){
		 
	  var aaaaa=c.$element.children().eq(0);
		c.$element.children().eq(0).css("position", "absolute").css({
          "margin":"0px",
          "top": function () {
                    return (document.documentElement.clientHeight - aaaaa.height()) / 2 + "px";
          },
